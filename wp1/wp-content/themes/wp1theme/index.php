<?php get_header(); ?>
    ...
    <section class="about" id="about" style="background: url(<?= CFS()->get('background_white'); ?>) center 100% repeat-x, url(<?= CFS()->get('background_black'); ?>) center 100% repeat-x, #1d1d1d;">
      <div class="container">
                ...
                <div class="team__item">
                  ...
                  <div class="team__icon-box">
                    ...
                    <?php
                      ...
                      if(!empty($row['team_youtube']['url'])) {
                    ?>
                        <a href="<?= $row['team_youtube']['url'] ?>" target="<?= $row['team_youtube']['target'] ?>"><i class="icon-youtube"></i></a>
                    <?php
                      }
                    ?>
          ...
          <div class="contact__icon-box">
            <div class="contact__item">
              ...
              <div class="contact__text">
                <a href="tel:<?= CFS()->get('contacts_phone'); ?>"><?= CFS()->get('contacts_phone'); ?></a>
              </div>
            </div>
            <div class="contact__item">
              ...
              <div class="contact__text">
                ...
                ?>
                    <a 
                    href="<?= CFS()->get('contacts_address')['url'] ?>" 
                    target="<?= CFS()->get('contacts_address')['target'] ?>">
                    <?= CFS()->get('contacts_address')['text'] ?></a>
                <?php
                  }
                ?>    
            ...
            <div class="contact__item">
              ...
              <div class="contact__text">
                <a href="mailto:<?= CFS()->get('contacts_email'); ?>">
                <?= CFS()->get('contacts_email'); ?></a>
              </div>
            </div>
          </div>
